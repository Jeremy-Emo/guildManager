 ...
 */
final class Version20200406063710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE defense ADD is_placed_by_default TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE defense DROP is_placed_by_default');
    }
}

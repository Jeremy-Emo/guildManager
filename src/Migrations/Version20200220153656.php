 ...
 */
final class Version20200220153656 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE monster DROP family');
        ...
        $this->addSql('ALTER TABLE scores ADD sss_fire_rift TINYINT(1) DEFAULT NULL, ADD sss_wind_rift TINYINT(1) DEFAULT NULL, ADD sss_water_rift TINYINT(1) DEFAULT NULL, ADD sss_dark_rift TINYINT(1) DEFAULT NULL, ADD sss_light_rift TINYINT(1) DEFAULT NULL, CHANGE best_rtarank_id best_rtarank_id INT DEFAULT NULL, CHANGE best_arena_rank_id best_arena_rank_id INT DEFAULT NULL, CHANGE gb10 gb10 INT DEFAULT NULL, CHANGE db10 db10 INT DEFAULT NULL, CHANGE nb10 nb10 INT DEFAULT NULL, CHANGE toa toa INT DEFAULT NULL, CHANGE toah toah INT DEFAULT NULL, CHANGE nb_six_stars nb_six_stars INT DEFAULT NULL, CHANGE min_speed min_speed INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gv_gscores CHANGE user_id user_id INT DEFAULT NULL, CHANGE attack_number attack_number INT DEFAULT NULL, CHANGE year year INT DEFAULT NULL');
        $this->addSql('ALTER TABLE monster ADD family VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE scores DROP sss_fire_rift, DROP sss_wind_rift, DROP sss_water_rift, DROP sss_dark_rift, DROP sss_light_rift, CHANGE best_rtarank_id best_rtarank_id INT DEFAULT NULL, CHANGE best_arena_rank_id best_arena_rank_id INT DEFAULT NULL, CHANGE gb10 gb10 INT DEFAULT NULL, CHANGE db10 db10 INT DEFAULT NULL, CHANGE nb10 nb10 INT DEFAULT NULL, CHANGE toa toa INT DEFAULT NULL, CHANGE toah toah INT DEFAULT NULL, CHANGE nb_six_stars nb_six_stars INT DEFAULT NULL, CHANGE min_speed min_speed INT DEFAULT NULL');
